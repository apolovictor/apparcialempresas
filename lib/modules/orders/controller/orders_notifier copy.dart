...
//           .collection(date.month.toString())
//           .doc(date.day.toString())
//           .collection(date.hour.toString())
//           .add({
//         'idTable': idTable,
...
// // class ClientNameController extends StateNotifier<TextEditingController> {
// //   ClientNameController() : super(clientName);
// //   static TextEditingController clientName = TextEditingController();

// //   setClientName(TextEditingController clientName) {
// //     state = clientName;
// //     return state;
// //   }
// // }
...
// //     StateNotifierProvider<ClientNameController, TextEditingController>(
// //         (ref) => ClientNameController());
