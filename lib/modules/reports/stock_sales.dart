...
class StockSales extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    print('widthSales ${sequenceAnimation['widthSales'].value}');
    print(sequenceAnimation['heightSales'].value);

    print(stockSalesController.value);
    print(stockSalesController.status);
